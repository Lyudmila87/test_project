...
class LoginPage(BasePage):
    ...
    def should_be_login_url(self):
        ...
        assert 'login' in self.browser.current_url, "'login' нет в текущем url браузера"
    ...
    def register_new_user(self,email, password):
        ...
        self.browser.find_element(*LoginPageLocators.REGISTRATION_PASSWORD_SUBMIT).send_keys(password)
